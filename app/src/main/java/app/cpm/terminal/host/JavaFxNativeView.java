 ...
 * for handing to {@link CpmTerminalHost#create}.
 *
 ...
 * ({@code native-host/CpmTerminalHost.h}) via {@link CpmTerminalHost}, not
 ...
 *
 * <p>This class -- together with {@link CpmTerminalHost}, {@link
 * CpmTerminalHostBinding}, and {@link CpmTerminalHostLibrary} -- is part of
 * the narrow native boundary (plan section 2.4/4.2). It is deliberately
 * package-private: only {@link CpmTerminalHost} (this package's own public
 * entry point) may hold a {@link MemorySegment}; no code outside {@code
 * app.cpm.terminal.host}/{@code app.cpm.terminal.ghostty} may reference it,
